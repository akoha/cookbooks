...
set_unless[:jira][:database_name]     = "jiradb"
set_unless[:jira][:enable_ssl]        = false
set_unless[:jira][:require_ssl]       = false
set_unless[:jira][:ssl_certificate_path] = "/etc/apache2/ssl/apache.pem"
set_unless[:jira][:ssl_key_path]      = nil
